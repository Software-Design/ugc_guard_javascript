...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.ChannelUser();
  });
  ...
  describe('ChannelUser', function() {
    it('should create an instance of ChannelUser', function() {
      // uncomment below and update the code to test ChannelUser
      //var instance = new UgcGuardJavascriptApi.ChannelUser();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.ChannelUser);
    });
