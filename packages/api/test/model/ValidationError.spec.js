...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new UgcGuardJavascriptApi.ValidationError();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.ValidationError);
    });
