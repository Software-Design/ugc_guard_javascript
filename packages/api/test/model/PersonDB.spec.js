...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.PersonDB();
  });
  ...
  describe('PersonDB', function() {
    it('should create an instance of PersonDB', function() {
      // uncomment below and update the code to test PersonDB
      //var instance = new UgcGuardJavascriptApi.PersonDB();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.PersonDB);
    });
