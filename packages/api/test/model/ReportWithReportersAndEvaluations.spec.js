...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.ReportWithReportersAndEvaluations();
  });
  ...
  describe('ReportWithReportersAndEvaluations', function() {
    it('should create an instance of ReportWithReportersAndEvaluations', function() {
      // uncomment below and update the code to test ReportWithReportersAndEvaluations
      //var instance = new UgcGuardJavascriptApi.ReportWithReportersAndEvaluations();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.ReportWithReportersAndEvaluations);
    });
