...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.MailTemplate();
  });
  ...
  describe('MailTemplate', function() {
    it('should create an instance of MailTemplate', function() {
      ...
      //var instance = new UgcGuardJavascriptApi.MailTemplate();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.MailTemplate);
    });
