...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new UgcGuardJavascriptApi.ValidationErrorLocInner();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.ValidationErrorLocInner);
    });
