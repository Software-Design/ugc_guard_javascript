...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.Action();
  });
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new UgcGuardJavascriptApi.Action();
      //expect(instance).to.be.a(UgcGuardJavascriptApi.Action);
    });
    ...
    it('should have the property isDestructive (base name: "is_destructive")', function() {
      // uncomment below and update the code to test the property isDestructive
      //var instance = new UgcGuardJavascriptApi.Action();
      //expect(instance).to.be();
    });
