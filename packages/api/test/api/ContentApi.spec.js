...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UgcGuardJavascriptApi.ContentApi();
  });
  ...
  describe('ContentApi', function() {
    ...
    describe('getAllContentOfReport', function() {
      it('should call getAllContentOfReport successfully', function(done) {
        //uncomment below and update the code to test getAllContentOfReport
        //instance.getAllContentOfReport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
